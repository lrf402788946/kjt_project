            ...
            <div class="more">
              <div class="tabs">
                <ul class="title" id="title">
                  ...
                  <li alt="ZRC">
                    <a href="${contextPath}/Talent/toTech">人才供求</a>
                  </li>
                </ul>
                ...
                <div class="content" id="content">
                  ...
                  <div class="contentlist">
                    <div class="pro" v-for="product in productlist00" :key="product.id">
                      <a href="${contextPath}/Supermarket/toProductDetailsPage?id=${product.id}">
                  ...
                  <div class="contentlist">正在跳转请稍后...</div>
                </div>
              </div>
            </div>
          </div>
...
.parttwo h2 span:nth-child(2),.parttwo h2 span:nth-child(3),.parttwo h2 span:nth-child(4){
	display: inline-block;
	width: 3px;
	height: 3px;
...
.fb a:nth-child(n+6) {display:none;}
.fb .falist:nth-child(n+7) {display:none;}
.contentlist .pro:nth-child(n+9),.js li:nth-child(n+9),.fw li:nth-child(n+9),.rc li:nth-child(n+9){display:none; }
</style>
